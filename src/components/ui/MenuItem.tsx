...
export function MenuItem({ active, disabled, expanded, hasChildren, inset, label, onPress, onToggle }: { active: boolean; disabled?: boolean; expanded?: boolean; hasChildren?: boolean; inset?: boolean; label: string; onPress: () => void; onToggle?: () => void }) {
